                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
												<form method="post" action="ModifyTags">
													<input type="text" name="tagName" value="<% out.println(t.tagName);%>" style="display:none;"/>
													<input type="text" name="marker" value="1" style="display:none;">
													<input type="submit" value="<% out.println(t.tagName);%>" style="text-align:left; width:100%; border:none; background-color:white;"/>
												</form>
											</div>
                                        </div>
                                	<form method="post" action="RemoveTags" >
